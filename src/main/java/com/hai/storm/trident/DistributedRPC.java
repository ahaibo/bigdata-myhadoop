package com.hai.storm.trident;

import com.google.common.collect.Maps;
import com.hai.storm.trident.groupby.FakeTweetSpout;
import com.hai.storm.tridentloganalyzer.Count;
...
//            DRPCClient client = new DRPCClient("RRPC-Server", 1234);
            DRPCClient client = new DRPCClient(Maps.newHashMap(), "RRPC-Server", 1234);
    ...
    public static StormTopology buildTopology(LocalDRPC drpc) {
        ...
        TridentState countryCount = topology
        ...
        topology.newDRPCStream("Count", drpc)
                ...
                .stateQuery(countryCount, new Fields("Country"), new MapGet(), new Fields("count")).each(new Fields("count"), new FilterNull());
